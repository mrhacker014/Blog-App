                  ...
                  <div className="flex flex-col gap-[30px] items-start justify-start my-[17px] rounded-[5px] w-full">
                    <div className="flex sm:flex-col flex-row gap-[25px] items-center justify-between w-full">
                      <Input
                        ...
                        className="font-light leading-[normal] md:text-[22px] p-0 placeholder:text-gray-400 sm:px-5 sm:text-xl text-2xl text-gray-400 text-left w-full"
                        wrapClassName="border border-gray-301 border-solid sm:flex-1 pl-[25px] pr-[35px] py-[21px] rounded-[5px] sm:w-full"
                        type="text"
                      ></Input>
                      <Input
                        name="field One"
                    ...
                    <Input
                      ...
                      className="font-light leading-[normal] md:text-[22px] p-0 placeholder:text-gray-400 sm:px-5 sm:text-xl text-2xl text-gray-400 text-left w-full"
                      wrapClassName="border border-gray-301 border-solid pl-[25px] pr-[35px] py-[21px] rounded-[5px] w-full"
                    ></Input>
                    <TextArea
                      className="border border-gray-301 border-solid font-light leading-[normal] pb-[35px] pl-[25px] pr-[35px] pt-[19px] sm:px-5 rounded-[5px] text-2xl md:text-[22px] placeholder:text-gray-400 text-gray-400 text-left sm:text-xl w-full"
                      name="field Three"
                      placeholder="Description"
                      name="field Three"
                      placeholder="Description"
                    ></TextArea>
                    <Button className="bg-indigo-900 cursor-pointer leading-[normal] min-w-[190px] py-6 rounded-[5px] text-center text-lg text-white-A700">
                      Send Message
                    </Button>
                  </div>
                </div>
