              ...
              <div className="bg-white-A700 flex flex-col items-center justify-end mt-[-132px] mx-auto p-12 md:px-10 sm:px-5 rounded-[25px] shadow-bs3 w-[84%] z-[1]">
                <div className="flex flex-col items-start justify-start w-[97%] md:w-full">
                  ...
                  <div className="flex sm:flex-col flex-row font-publicsans sm:gap-10 items-center justify-between mt-[50px] w-full">
                    ...
                    <Button
                      className="bg-white-A700 border border-pink-300 border-solid cursor-pointer flex items-center justify-center min-w-[191px] sm:mt-0 my-1 pr-[29px] py-5 rounded-[5px]"
                      leftIcon={
                        <Img
                    ...
                    >
                      <div className="font-medium leading-[normal] sm:pr-5 text-left text-lg text-pink-300">
                        Share Now
                      </div>
                    </Button>
                  </div>
            ...
            <div className="flex flex-col items-start justify-start w-[74%] md:w-full">
              ...
              <div className="flex flex-col gap-[15px] items-start justify-start mt-[50px] rounded-[5px] w-[52%] md:w-full">
                ...
                <div className="flex sm:flex-col flex-row gap-[15px] items-center justify-between rounded-[5px] w-full">
                  <Button className="bg-gray-200 cursor-pointer font-thin leading-[normal] min-w-[96px] py-[9px] rounded-[5px] text-bluegray-600 text-center text-lg">
                    Writing
                  </Button>
                  <Button className="bg-gray-200 cursor-pointer font-thin leading-[normal] min-w-[97px] py-[9px] rounded-[5px] text-bluegray-600 text-center text-lg">
                    Tutorial
                  </Button>
                  <Button className="bg-gray-200 cursor-pointer font-thin leading-[normal] min-w-[93px] py-[9px] rounded-[5px] text-bluegray-600 text-center text-lg">
                    How to
                  </Button>
                  <Button className="bg-gray-200 cursor-pointer font-thin leading-[normal] min-w-[77px] py-[9px] rounded-[5px] text-bluegray-600 text-center text-lg">
                    Book
                  </Button>
                  <Button className="bg-gray-200 cursor-pointer font-thin leading-[normal] min-w-[77px] py-[9px] rounded-[5px] text-bluegray-600 text-center text-lg">
                    2020
