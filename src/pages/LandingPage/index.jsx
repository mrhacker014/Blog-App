            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
              <div className="flex flex-col gap-8 justify-start">
                ...
                <div className="flex sm:flex-col flex-row gap-[25px] items-center justify-end md:ml-[0] ml-[259px] rounded-[35.5px] w-[56%] md:w-full">
                  <Button className="bg-indigo-900 cursor-pointer leading-[normal] min-w-[221px] py-[21px] rounded-[35.5px] shadow-bs text-2xl md:text-[22px] text-center text-white-A700 sm:text-xl tracking-[0.12px]">
                    Read More
                  </Button>
                  <Button className="border-2 border-indigo-201 border-solid cursor-pointer leading-[normal] min-w-[271px] py-[21px] rounded-[35.5px] text-2xl md:text-[22px] text-center text-indigo-900 sm:text-xl tracking-[0.12px]">
                    Listen to Podcasts
                  </Button>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-5 items-center justify-start max-w-[1111px] mt-[162px] mx-auto md:px-5 w-full">
            <div className="flex sm:flex-col flex-row md:gap-10 items-center justify-between w-full">
              <div className="flex sm:flex-1 sm:flex-col flex-row gap-[18px] items-center justify-between w-[39%] sm:w-full">
                <Button className="bg-gray-300 flex h-[76px] items-center justify-center p-[13px] rounded-[50%] w-[76px]">
                  <Img
                    className="h-[50px]"
            ...
            >
              <div className="bg-white-A700 flex flex-1 flex-col items-center justify-start p-[13px] rounded-[5px] shadow-bs1 w-full">
                <div className="flex flex-col gap-[15px] items-center justify-start my-[7px] rounded-[5px] w-full">
                  ...
                  >
                    <Button className="bg-gray-600_76 flex h-[72px] items-center justify-center mb-[9px] p-[18px] rounded-[50%] w-[72px]">
                      <Img
                        className="h-[35px]"
                  ...
                  <div className="flex flex-col items-start justify-start w-full">
                    ...
                    <div className="flex sm:flex-col flex-row font-publicsans gap-[50px] items-center justify-start mt-5 w-[65%] md:w-full">
                      <div className="flex flex-row gap-2.5 items-center justify-start w-[34%] sm:w-full">
                        <Button className="bg-light_blue-50 flex h-[55px] items-center justify-center p-3 rounded-[50%] w-[55px]">
                          <Img
                            className="h-[30px]"
                      ...
                      <div className="flex flex-row gap-2.5 items-center justify-center w-[24%] sm:w-full">
                        <Button className="bg-lime-50 flex h-[55px] items-center justify-center p-3 rounded-[50%] w-[55px]">
                          <Img
                            className="h-[30px]"
                      ...
                      <div className="flex flex-row gap-2.5 items-center justify-between w-[23%] sm:w-full">
                        <Button className="bg-red-50 flex h-[55px] items-center justify-center p-3 rounded-[50%] w-[55px]">
                          <Img
                            className="h-[30px]"
                    ...
                    <Button
                      className="common-pointer bg-indigo-900_67 cursor-pointer flex items-center justify-center min-w-[255px] mt-5 pl-7 py-[25px] rounded-[5px]"
                    ...
                    >
                      <div className="font-bold font-publicsans leading-[normal] sm:pl-5 text-indigo-900 text-left text-lg tracking-[0.12px]">
                        Continue Reading
                      </div>
                    </Button>
                  </div>
              ...
              <div className="flex flex-col gap-[7px] justify-start w-[44%] md:w-full">
                <div className="flex flex-col gap-5 items-start justify-start rounded-[5px] w-full">
                  <Input
                    ...
                    className="font-bold leading-[normal] p-0 placeholder:text-indigo-900_79 sm:px-5 text-indigo-900_79 text-left text-lg w-full"
                    wrapClassName="bg-white-A700 border border-indigo-900 border-solid pl-[23px] pr-[35px] py-[25px] rounded-[5px] w-full"
                    type="email"
                  ></Input>
                  <Button className="bg-indigo-900 cursor-pointer font-semibold leading-[normal] min-w-[137px] py-[18px] rounded-[5px] text-center text-lg text-white-A700">
                    Subscribe
                  </Button>
                </div>
                <Button className="bg-pink-300 flex h-[77px] items-center justify-center md:ml-[0] ml-[283px] mr-[77px] p-2.5 rounded-[50%] shadow-bs2 w-[77px]">
                  <Img
                    className="h-[55px]"
