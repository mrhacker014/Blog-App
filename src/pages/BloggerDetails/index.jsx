        ...
        <div className="flex flex-col items-center justify-start w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mb-2.5 w-full">
                <div className="md:h-[315px] h-[349px] relative w-[63%] md:w-full">
                  ...
                  <div className="absolute bottom-[0] flex flex-col items-start justify-start right-[0] w-4/5">
                    <Button className="bg-white-A700_3f cursor-pointer font-light font-publicsans leading-[normal] min-w-[82px] py-[5px] rounded-[5px] text-center text-lg text-white-A700">
                      Writer
                    </Button>
                    <Text
              ...
              <div className="flex md:flex-col flex-row gap-[22px] items-center justify-between mt-2 w-full">
                ...
                <div className="flex flex-col items-start justify-start">
                  <div className="flex flex-row sm:gap-10 items-center justify-between w-full">
                    <Button className="bg-gray-200 cursor-pointer font-light leading-[normal] min-w-[74px] py-1 rounded-[5px] text-base text-bluegray-600 text-center">
                      Writer
                    </Button>
                    <Text
                  ...
                  <div className="flex flex-row gap-5 items-center justify-start mt-2.5 w-[42%] md:w-full">
                    <Button
                      className="bg-indigo-900 cursor-pointer flex items-center justify-center min-w-[132px] pr-5 py-3.5 rounded-[5px]"
                      leftIcon={
                        <Img
                    ...
                    >
                      <div className="font-light leading-[normal] text-left text-sm text-white-A700">
                        Play Now
                      </div>
                    </Button>
                    <Text
          ...
          <div className="flex flex-col items-start justify-start max-w-[1106px] mt-[100px] mx-auto md:px-5 w-full">
            <div className="flex sm:flex-col flex-row gap-[18px] items-center justify-start w-2/5 md:w-full">
              <Button className="bg-gray-302 flex h-[76px] items-center justify-center p-[13px] rounded-[50%] w-[76px]">
                <Img
                  className="h-[50px]"
              ...
              <div className="md:gap-5 gap-[22px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 justify-center min-h-[auto] w-full">
                <div className="bg-white-A700 flex flex-1 flex-col items-center justify-start p-[13px] rounded-[5px] shadow-bs1 w-full">
                  <div className="flex flex-col gap-[15px] items-center justify-start mb-3 mt-0.5 rounded-[5px] w-full">
                    ...
                    >
                      <Button className="bg-indigo-900_4f flex h-[72px] items-center justify-center p-[18px] rounded-[50%] w-[72px]">
                        <Img
                          className="h-[35px]"
